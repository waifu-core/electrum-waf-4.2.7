...
try:
    ...
    print "You need to have PyQT installed to run Electrum-WAF in graphical mode."
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.setWindowTitle("Electrum-WAF")
    ...
    def set_balances(self, btc_balance):
        ...
        self.setWindowTitle("Electrum-WAF %s - %s %s" % (electrum_version, amount, unit))
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        ...
        self.setWindowTitle("Electrum-WAF - " + _("Receive Dogecoin payment"))
